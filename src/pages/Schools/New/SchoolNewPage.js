...
class SchoolNewPage extends React.Component {
    constructor(props) {
        super(props);
        if (!this.global.user) {
    ...
    performCreate = async (evt) => {
        ...
        const result = await SchoolsService.addSchool(formData);
    ...
    render() {
        return(
            <div className="page-content mt-30">
                <form className="form-content" onSubmit={this.performCreate}>
                    <h1>Add a School</h1>
